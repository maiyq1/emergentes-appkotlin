...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var stopButton: ExtendedFloatingActionButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        */
        ...
        modelNode = ArModelNode(sceneView.engine,PlacementMode.INSTANT).apply {
            loadModelGlbAsync(
                glbFileLocation = "models/wooden_table.glb",
                scaleToUnits = 1f,
   ...
   private fun placeModel(){
    ...
    - DICCIONARIO DE APIS/SERVICIOS
    - QUÉ DEVOLVERÁ (ALTURA,PESO,TAMAÑO)
